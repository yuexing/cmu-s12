...
public class ArrayDB {
	...
	public synchronized User select(int id) {
		if(id < 0) return null;
	...
	public synchronized ArrayList<User> select(){	
		log.debug("select ");
		return user_tbl;
	}
	 ...
	 * @return
	 */
	public synchronized ArrayList<User> select(String field, Object o){
		return null;
	}
	/**
	 * TODO: move away!
	 ...
	 * @return
	 */
	public synchronized User select(String email){
