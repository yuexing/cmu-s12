...
<title>Add A Benefit and View All Benefits</title>
...
<body>
	<div class="container">
		...
		<br /> If you cannot add the benefit because of duplication check,
		please click <a href="addbenefit.do?force=true">here</a>
		<hr />

		<jsp:include page="frag/frag_benefits.jsp"></jsp:include>

		<form action="addbenefit.do" method="post"
