...
<title>Add A Deal and View All Deals</title>
...
<body>
	...
	<div class="container">
		...
		<form action="adddeal.do" method="post" enctype="multipart/form-data">
			...
			<table>
				<tr>
					...
					<td><input type="text"
						value="<c:if test="${ not empty form }">${ form.content }</c:if>"
